...
class S3Manager(AWSClient):
    ...
    def __init__(self, region_name: str = "us-east-2"):
        ...
        self.logger = GenericLogger(name="S3Manager", level="INFO")
    ...
    def _initialize_bootstrap(self, project_name: str, bucket: str) -> Dict[str, str]:
        ...
        subdirs = ["scripts", "data", "sql", "temp", "logs"]
    ...
    def write_text_file(self, bucket: str, prefix: str, filename: str, content: str, extension: str) -> str:
    ...
    def copy_file(self, source_file_uri: str, target_folder_uri: str) -> str:
        """
